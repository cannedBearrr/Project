            ...
            child: Padding(
              ...
              child: Stack(
                children: [
                  ...
                  Positioned(
                    top: 20,
                    right: ((MediaQuery.sizeOf(context).width > 1260) ? MediaQuery.sizeOf(context).width * 0.25 : (MediaQuery.sizeOf(context).width > 740) ? MediaQuery.sizeOf(context).width * 0.5 - 315 : min(-45 + MediaQuery.sizeOf(context).width / 4, 55)),
                    child: Container(
                      width: 250,
                      height: 300,
                  ...
                  FittedBox(
                    child: Column(
                      children: [
                        ...
                        Padding(
                          padding: EdgeInsets.symmetric(horizontal: (MediaQuery.sizeOf(context).width > 1260) ? MediaQuery.sizeOf(context).width * 0.25 : (MediaQuery.sizeOf(context).width > 740) ? MediaQuery.sizeOf(context).width * 0.5 - 315 : min(-45 + MediaQuery.sizeOf(context).width / 4, 55)),
                          child: Form(
                            key: _formKey,
                            child: Column(
