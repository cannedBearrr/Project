                    ...
                    children: [
                      Padding(
                        ...
                        child: TweenAnimationBuilder<double>(
                          ...
                          tween: Tween<double>(begin: tV_1, end: tV,),
                          duration: const Duration(milliseconds: 600),
                          onEnd: () {
    if (tV == 0.2) {tlPri = 0; print("low"); _05to1tl = 0.5;}
                          },
                            ...
                            return GestureDetector(
                              onTap: () {
                                setState(() {
                                  tV_1 = value;
                                  tV = tV == 0.2 ? 0.6 : 0.2;
                                  if (tV == 0.6) {tlPri = 1; print("hi"); _05to1tl = 1.0;}
                                  print(tV);
                                });
                              },
                              child: Container(
                                width: MediaQuery.sizeOf(context).width * value,
                                height: MediaQuery.sizeOf(context).height * ((value+0.3)/2+0.25),
              ...
              Indexed(
                ...
                child: Positioned(
                  ...
                  child: Padding(
                    ...
                    child: TweenAnimationBuilder<double>(
                      curve: Curves.easeOutQuart,
                      tween: Tween<double>(begin: yV_1, end: yV,),
                      duration: const Duration(milliseconds: 600),
                      onEnd: () {
                        if (yV == 0.22) {trPri = 0; print("low1"); _05to1tr = 0.5;}
                        print(_05to1tr);
                        },
                      builder: (BuildContext context, double value, Widget? child) {
                        return GestureDetector(
                          onTap: () {
                            setState(() {
                              yV_1 = value;
                              yV = yV == 0.22 ? 0.5 : 0.22;
                              if (yV == 0.5) {trPri = 1; print("hi1"); _05to1tr = 1.0;}
                              print(yV);
                            });
                          },
                        child: Container(
                          ...
                          alignment: const AlignmentDirectional(1.0, -1.0),
                          child: Container(
                          width: MediaQuery.sizeOf(context).width * (value+0.38),
                          height: MediaQuery.sizeOf(context).height * value,
                          decoration: const BoxDecoration(
                          color: Color(0x00FFFFFF),
                          ),
                          child: Stack(
